...
def prandtl_glauert_panel_pressure(mach, alpha_deg, q_inf):
    """Prandtl-Glauert linearised subsonic DeltaCp for a flat panel.

    Uses the same flat-plate thin-airfoil coefficient form as the supersonic
    Ackeret model, with beta = sqrt(1 - M^2).
    """
